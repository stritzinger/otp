...
#if (!defined(NATIVE_ERLANG_STACK) || defined(__aarch64__) || defined(__arm__)) && defined(JIT_HARD_DEBUG)
    /* Holds the initial thread stack pointer. Used to ensure that everything
     * that is pushed to the stack is also popped. */
    UWord *initial_sp;
#elif defined(NATIVE_ERLANG_STACK) && defined(DEBUG) && !defined(__aarch64__) && !defined(__arm__)
