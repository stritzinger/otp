...
void BeamModuleAssembler::emit_copy_words_increment(arm::Gp from,
    ...
    if (count <= 16) {
        while (count >= 4) {
            a.ldp(a32::q30, a32::q31, arm::Mem(from).post(sizeof(UWord[4])));
            a.stp(a32::q30, a32::q31, arm::Mem(to).post(sizeof(UWord[4])));
            count -= 4;
        }
    } else {
    ...
    if (count >= 2) {
        a.ldr(a32::q30, arm::Mem(from).post(sizeof(UWord[2])));
        a.str(a32::q30, arm::Mem(to).post(sizeof(UWord[2])));
        count -= 2;
    }
...
void BeamGlobalAssembler::emit_arith_compare_shared() {
    ...
    a.ldur(a32::d0, emit_boxed_val(boxed_ptr1, sizeof(Eterm)));
    a.ldur(a32::d1, emit_boxed_val(boxed_ptr2, sizeof(Eterm)));
    a.fcmpe(a32::d0, a32::d1);
    a.ret(a32::x30);
...
void BeamGlobalAssembler::emit_is_in_range_shared() {
    ...
    a.ldur(a32::d0, emit_boxed_val(boxed_ptr, sizeof(Eterm)));
